...
There have been a few questions about whether what we're trying to do could be hosted on the internet: [yes it can!](https://rawgit.com/pmccolgan/CoderDojo-JavaScript/master/Week3/hosted_canvas.html)
